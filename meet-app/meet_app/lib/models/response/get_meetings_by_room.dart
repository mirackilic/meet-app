...
GetMeetingsByRoomResponse getMeetingsByRoomResponseFromJson(String str) =>
    GetMeetingsByRoomResponse.fromJson(json.decode(str));

String getMeetingsByRoomResponseToJson(GetMeetingsByRoomResponse data) =>
...
class GetMeetingsByRoomResponse {
  ...
  factory GetMeetingsByRoomResponse.fromJson(Map<String, dynamic> json) =>
      GetMeetingsByRoomResponse(
        odataContext: json["@odata.context"],
        value: json["value"] == null
            ? []
            : List<Meeting>.from(
                json["value"]!.map((x) => Meeting.fromJson(x))),
      );
